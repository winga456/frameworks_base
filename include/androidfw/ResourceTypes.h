...
struct ResTable_config
{
  ...
  enum {
    ...
    enum {
        ...
        UI_MODE_NIGHT_BLACKOUT = ACONFIGURATION_UI_MODE_NIGHT_BLACKOUT << SHIFT_UI_MODE_NIGHT,
        UI_MODE_NIGHT_CUSTOM_1 = ACONFIGURATION_UI_MODE_NIGHT_CUSTOM_1 << SHIFT_UI_MODE_NIGHT,
        UI_MODE_NIGHT_CUSTOM_2 = ACONFIGURATION_UI_MODE_NIGHT_CUSTOM_2 << SHIFT_UI_MODE_NIGHT,
        UI_MODE_NIGHT_CUSTOM_3 = ACONFIGURATION_UI_MODE_NIGHT_CUSTOM_3 << SHIFT_UI_MODE_NIGHT,
        UI_MODE_NIGHT_CUSTOM_4 = ACONFIGURATION_UI_MODE_NIGHT_CUSTOM_4 << SHIFT_UI_MODE_NIGHT,
    };
