...
import com.android.internal.util.VRToxinUtils;
...
public class DexoptDialog extends Dialog {
    ...
    private void startLogoAnimation() {
        ...
        final Animation transAnim = new TranslateAnimation(0, 0, 0, -VRToxinUtils.dpToPx(mContext, 30));
        ...
        Animation dropAnim = new TranslateAnimation(0, 0, -VRToxinUtils.dpToPx(mContext, 300), 0);
    ...
    private void setInitialState() {
        ...
        Animation transAnim = new TranslateAnimation(0, 0, 0, -VRToxinUtils.dpToPx(mContext, 300));
