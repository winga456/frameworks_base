...
public class StatusBarHeaderMachine {
    ...
    private static final String STATUS_BAR_HEADER_UPDATE_ACTION = "com.android.systemui.vrtoxin.STATUS_BAR_HEADER_UPDATE";
    ...
    private class SettingsObserver extends ContentObserver {
        ...
        public void onChange(boolean selfChange) {
            doUpdateStatusHeaderObservers(true); // simplest way to update to different headers without clobbering API
            updateEnablement();
        }
    }
