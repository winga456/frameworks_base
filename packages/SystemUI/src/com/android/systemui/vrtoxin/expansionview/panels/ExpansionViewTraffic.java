...
*
*/
public class ExpansionViewTraffic extends LinearLayout {
    ...
    private Handler mTrafficHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            if (shouldHide(rxData, txData, timeDelta)) {
                ...
                if (! output.contentEquals(mTextView.getText())) {
                    if (mTextView != null) {
    ...
    class SettingsObserver extends ContentObserver {
        ...
        void observe() {
            ...
            Uri uri = Settings.System.getUriFor(Settings.System.EXPANSION_VIEW_NETWORK_TRAFFIC_STATE);
            resolver.registerContentObserver(uri, false,
                    this, UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.System
                    .getUriFor(Settings.System.EXPANSION_VIEW_NETWORK_TRAFFIC_AUTOHIDE), false,
                    this, UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.System
                    .getUriFor(Settings.System.EXPANSION_VIEW_NETWORK_TRAFFIC_AUTOHIDE_THRESHOLD), false,
                    this, UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.System
                    .getUriFor(Settings.System.EXPANSION_VIEW_NETWORK_TRAFFIC_HIDE_ARROW), false,
                    this, UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.System
                    .getUriFor(Settings.System.EXPANSION_VIEW_NETWORK_TRAFFIC_COLOR), false,
                    this, UserHandle.USER_ALL);
        }
     ...
     *  @hide
     */
    public ExpansionViewTraffic(Context context) {
        this(context, null);
    }
     ...
     *  @hide
     */
    public ExpansionViewTraffic(Context context, AttributeSet attrs) {
     ...
     *  @hide
     */
    public ExpansionViewTraffic(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        final Resources resources = getResources();
        txtSizeSingle = resources.getDimensionPixelSize(R.dimen.expansion_view_net_traffic_single_text_size);
        txtSizeMulti = resources.getDimensionPixelSize(R.dimen.expansion_view_net_traffic_multi_text_size);
    ...
    protected void onFinishInflate() {
        ...
        mTextView = (TextView) findViewById(R.id.expansion_view_traffic_text);
        mIconView = (ImageView) findViewById(R.id.expansion_view_traffic_icon);
    }
    ...
    private void updateSettings() {
        ...
        mHideArrows = Settings.System.getIntForUser(resolver,
                Settings.System.EXPANSION_VIEW_NETWORK_TRAFFIC_HIDE_ARROW, 0,
                UserHandle.USER_CURRENT) == 1;
        if (mHideArrows) {
            updateTrafficDrawable();
        }
 
        mState = Settings.System.getInt(resolver, Settings.System.EXPANSION_VIEW_NETWORK_TRAFFIC_STATE, 0);
 
        mNetworkTrafficColor = Settings.System.getInt(resolver,
                Settings.System.EXPANSION_VIEW_NETWORK_TRAFFIC_COLOR, -2);
        ...
        if (mTextView != null) {
            mTextView.setTextColor(mNetworkTrafficColor);
        }
        if (mIconView != null) {
            mIconView.setColorFilter(mNetworkTrafficColor, PorterDuff.Mode.SRC_ATOP);
        }
    ...
    private void updateTrafficDrawable() {
        ...
        Drawable drw = null;
        if (!mHideArrows) {
            int trafficDrawableResId = 0;
            if (isSet(mState, MASK_UP + MASK_DOWN)) {
                trafficDrawableResId = R.drawable.expansion_view_traffic_inout;
            } else if (isSet(mState, MASK_UP)) {
                trafficDrawableResId = R.drawable.expansion_view_traffic_out;
            } else if (isSet(mState, MASK_DOWN)) {
                trafficDrawableResId = R.drawable.expansion_view_traffic_in;
            }
            if (trafficDrawableResId != 0) {
                drw = getContext().getResources().getDrawable(trafficDrawableResId);
            }
        }
