...
public class PaPieController extends EdgeGestureManager.EdgeGestureActivationListener implements OnTouchListener, OnClickListener{
    ...
    private static PaPieHelper mPieHelper;
    ...
    private PaPieControlPanel mPieControlPanel;

    private PaPieItem mBack;
    private PaPieItem mHome;
    private PaPieItem mMenu;
    private PaPieItem mRecent;
    private PaPieItem mLastApp;
    private PaPieItem mKillTask;
    private PaPieItem mNowOnTap;
    private PaPieItem mPower;
    private PaPieItem mPowerMenu;
    private PaPieItem mExpandedDesktop;
    private PaPieItem mScreenshot;

    protected PaPieMenu mPie;
    ...
    public void detachPie() {
        if(mPieControlPanel != null) {
            mBar.updatePaPieControls(!mPieAttached);
        }
    }
    ...
    private void addPieInLocation(int gravity) {
        ...
        // pie panel
        mPieControlPanel = (PaPieControlPanel) View.inflate(mContext,
                R.layout.pa_pie_control_panel, null);
    ...
    public PaPieControlPanel getControlPanel() {
        return mPieControlPanel;
    }

    public void populateMenu() {
        mBack = makeItem(R.drawable.ic_sysbar_back, 1, PaPieConstants.BACK_BUTTON, false);
        mHome = makeItem(R.drawable.ic_sysbar_home, 1, PaPieConstants.HOME_BUTTON, false);
        mRecent = makeItem(R.drawable.ic_sysbar_recent, 1, PaPieConstants.RECENT_BUTTON, false);
        mMenu = makeItem(R.drawable.ic_sysbar_menu, 1, PaPieConstants.MENU_BUTTON, true);
        mLastApp = makeItem(R.drawable.ic_sysbar_lastapp, 1, PaPieConstants.LAST_APP_BUTTON, true);
        mKillTask = makeItem(R.drawable.ic_sysbar_killtask, 1, PaPieConstants.KILL_TASK_BUTTON, true);
        mNowOnTap = makeItem(R.drawable.ic_sysbar_now_on_tap, 1, PaPieConstants.NOW_ON_TAP, true);
        mPower = makeItem(R.drawable.ic_sysbar_power, 1, PaPieConstants.POWER_BUTTON, true);
        mPowerMenu = makeItem(R.drawable.ic_sysbar_power_menu, 1, PaPieConstants.POWER_MENU_BUTTON, true);
        mExpandedDesktop = makeItem(R.drawable.ic_sysbar_expanded_desktop, 1, PaPieConstants.EXPANDED_DESKTOP_BUTTON, true);
        mScreenshot = makeItem(R.drawable.ic_sysbar_screenshot, 1, PaPieConstants.SCREENSHOT_BUTTON, true);
    ...
    protected PaPieItem makeItem(int image, int l, String name, boolean lesser) {
        ...
        return new PaPieItem(view, mContext, l, name, lesser);
    }
    ...
    public void setControlPanel(PaPieControlPanel panel) {
        mPanel = panel;
        mPie = new PaPieMenu(mContext, mPanel);
