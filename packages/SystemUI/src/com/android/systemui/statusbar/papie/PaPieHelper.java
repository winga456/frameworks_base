...
public class PaPieHelper {
    ...
    private static PaPieHelper mInstance;
    ...
    public static PaPieHelper getInstance() {
        if (mInstance == null) mInstance = new PaPieHelper();
        return mInstance;
    }
    ...
    public String getSimpleDate() {
        SimpleDateFormat sdf = new SimpleDateFormat(
                mContext.getString(R.string.pa_pie_date_format));
    ...
    public String getSimpleTime() {
        SimpleDateFormat sdf = new SimpleDateFormat(
                mContext.getString(is24Hours() ? R.string.pa_pie_hour_format_24 :
                        R.string.pa_pie_hour_format_12));
    ...
    public String getAmPm() {
        ...
        if (!is24Hours()) {
            SimpleDateFormat sdf = new SimpleDateFormat(
                    mContext.getString(R.string.pa_pie_am_pm));
