...
public class RecentHeader extends CardHeader {
    ...
    private int getTextColor() {
        ...
        boolean useTextColor = Settings.System.getIntForUser(resolver,
        ...
        int textColorLight = res.getColor(R.color.card_text_light_color);
        int textColorDark = res.getColor(R.color.card_text_dark_color);
        int defaultTextColor = ColorHelper.isColorDark(cardColor) ?
